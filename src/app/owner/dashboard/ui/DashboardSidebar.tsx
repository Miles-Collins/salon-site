...
export default function DashboardSidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 bg-gradient-to-b from-slate-800 to-slate-900 text-white flex-col shadow-2xl z-40">
        {/* User Profile Section */}
        <div className="p-6 border-b border-slate-700">
          <div className="flex flex-col items-center">
            <div className="w-20 h-20 rounded-full bg-slate-700 flex items-center justify-center mb-3 shadow-lg">
              {user?.imageUrl ? (
                <img 
                  src={user.imageUrl} 
